...
//                 <Grid container spacing={2}>
//                   <Grid item xs={6}><Typography>Publish: {application.publish || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Expected Revenue: {application.expectedRevenue || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Missed Revenue: {application.missedRevenue || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>City: {application.city || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Contact Name: {application.contactName || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Actual Revenue: {application.actualRevenue || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Target Date: {application.targetDate || "--"}</Typography></Grid>
//                   <Grid item xs={6}><Typography>Assigned Recruiter(s): {application.assignedRecruiter || "--"}</Typography></Grid>
//                 </Grid>
//               </CardContent>
//             </Card>
